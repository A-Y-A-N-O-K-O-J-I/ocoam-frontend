...
export default function MobileNavigation() {
  ...
  const navItems = [
    { icon: FaHome, label: "Dashboard", path: "/moderator/dashboard" },
    { icon: FaVideo, label: "Classes", path: "/moderator/classes" }, // Removed hardcoded active
    { icon: FaUsers, label: "Students", path: "/moderator/students" },
    { icon: FaBookAtlas, label: "Library", path: "/moderator/library" },
    { icon: FaCog, label: "Profile", path: "/moderator/profile" },
  ];
